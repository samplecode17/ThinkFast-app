<template>
    <div class="justify-start pl-2 md:w-2/3 w-full mx-auto space-y-6">
        <button v-if="!showComments" @click="showComments = !showComments" class="hover:text-blue-600 transition">
            Show comments
        </button>
    </div>
    <div v-if="showComments" class="md:w-2/3 w-full mx-auto space-y-6">
        <!-- New Comment Form -->
